namespace video_trimmer
{
    partial class VideoTrimmerForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Click += async (sender, e) => await SelectDirectoryButton_ClickAsync(sender, e);

            //this.button1.Click += new System.EventHandler(this.SelectDirectoryButton_ClickAsync);
            // 
            // DirectoryLabel
            // 
